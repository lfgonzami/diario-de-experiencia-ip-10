namespace Lab8
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            cmbSeleccion.Items.Add("N�mero Perfecto");
        ...
        private void cmbSeleccion_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch(cmbSeleccion.SelectedIndex)
            {
                ...
                case 0:
                    tctSeleccion.SelectedTab = tabSumatoria; //MUESTRA LA PESTA�A DE SUMATORIA
                    break;
                case 1:
                    tctSeleccion.SelectedTab = tabTablas; // MUESTA LA PESTA�A DE TABLAS
                    break;
                case 2:
                    tctSeleccion.SelectedTab = tabNPerfecto; // MUESTRA LA PESTA�A DE N�MERO PERFECTO
                    break;
        ...
        private void btnSeleccionar_Click(object sender, EventArgs e)
        {
            ...
            else if (tctSeleccion.SelectedTab == tabNPerfecto)
            {
                ...
                if (sum == num)
                {
                    lblResultadoPerfecto.Text = "El n�mero " + num.ToString() + " es perfecto.";
                }
                else
                {
                    lblResultadoPerfecto.Text = "El n�mero " + num.ToString() + " no es perfecto.";
                }
